    ...
    <StyledWrapper>
      <div className="card-profile">
        <div className="prof-photo">
          <div className="prof-photo-num">MK</div>
          <div className="prof-avatar">MK</div>
          <div className="prof-status-badge">● ONLINE</div>
        </div>
        <div className="prof-body">
          <div className="prof-handle">@matthieu.k</div>
          <div className="prof-name">MATTHIEU<br />KRANZ</div>
          <div className="prof-bio">
            Brutalist designer &amp; freelance typographer. Makes ugly things that
            work perfectly. Berlin / Paris.
          </div>
        </div>
