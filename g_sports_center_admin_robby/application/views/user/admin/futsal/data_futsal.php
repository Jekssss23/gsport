  ...
  <div class="main-card mb-3 card">
                                          <div class="card-header">
                                            ...
                                            <div class="btn-actions-pane-right">
                                                <div class="nav">
                                                    <a data-toggle="tab" href="#tab_jenis_member" id="tombol_tab_membership" class="border-0 btn-transition active btn btn-outline-primary" onclick="jenis_futsal()">Setting</a>
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content">
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div role="group" class="btn-group-sm btn-group">
                                                                    <button type="button" class="btn btn-outline-info btn-xs" data-toggle="modal" data-target="#edit" onclick="edit('<?php echo $d1['id_futsal'] ?>')">
                                                            Edit
                                                          </button>
                                                                </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-subheading"><?php echo $diskon_futsal ?> %</div>
                                                            </div>
                                                  ...
                                                  <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#tambah_futsal_turnamen">Tambah</button>
                                                  <br>
                                                  <br>
                                                   <table class="table table-striped table-bordered">
                                                    <thead>
                                                    ...
                                                    foreach ($futsal_turnamen as $d1) { ?>
                                                      <tr>
                                                        ...
                                                        <td>
                                                          ...
                                                          <div role="group" class="btn-group-sm btn-group">
                                                           <button type="button" class="btn btn-outline-info btn-xs" data-toggle="modal" data-target="#edit_futsal_turnamen" onclick="edit_turnamen('<?php echo $d1['id_futsal_turnamen'] ?>')">
                                                           Edit</button>
                                                           <button type="button" class="btn btn-outline-info btn-xs" onclick="hapus_turnamen('<?php echo $d1['id_futsal_turnamen'] ?>','<?php echo $d1['paket'] ?>')">
                                                          Hapus
                                                        </button>
                                                      </div>
                                                  ...
                                                  <?php foreach ($galerry as $k => $v) { 
                                                    ?>
                                                      <div class="col-md-3 mb-3 justify-content-center">
                                                       ...
                                                       <a href="<?php echo base_url() ?>file/public/futsal/<?php echo $v['file'] ?>"  data-lightbox="image-1" data-title="My Foto" >
                                                         <img width="100%" class="rounded img-thumbnail" src="<?php echo base_url() ?>file/public/futsal/<?php echo $v['file'] ?>" alt="" >
                                                       </a>
                                                       <br>
