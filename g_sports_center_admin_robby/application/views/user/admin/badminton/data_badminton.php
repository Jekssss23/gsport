                                            ...
                                            <div class="btn-actions-pane-right">
                                                <div class="nav">
                                                   <a href="<?php echo base_url('user/admin/atur_lapangan_atas') ?>" class="border-0 btn-transition btn btn-outline-primary">Atur Lapangan </a>
                                                    <a data-toggle="tab" href="#tab_jenis_member" id="tombol_tab_membership" class="border-0 btn-transition active btn btn-outline-primary" onclick="jenis_badminton()">Setting</a>
                                                          ...
                                                          <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div role="group" class="btn-group-sm btn-group">
                                                                    <button type="button" class="btn btn-outline-info btn-xs" data-toggle="modal" data-target="#edit" onclick="edit('<?php echo $d1['id_badminton'] ?>')">
                                                            Edit
                                                          </button>
                                                                </div>
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                ...
                                                                <div class="widget-subheading"><?php echo $diskon_badminton ?> %</div>
                                                            </div>
                                                ...
                                                <li class="list-group-item">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading">Selisih tanpa shoutlecook</div>
                                                                <div class="widget-subheading"><?php echo 'Rp. '.number_format($shoutlecook['selisih_tanpa_shoutlecook']) ?></div>
                                                            </div>
                                                            <div class="widget-content-right">
                                                                <div role="group" class="btn-group-sm btn-group">
                                                                    <button type="button" class="btn-shadow btn btn-outline-primary"  data-toggle="modal" data-target="#edit_selisih_shoutlecook" onclick="edit_selisih()">Edit</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                  ...
                                                  <button type="button" class="btn btn-outline-info btn-sm" data-toggle="modal" data-target="#tambah_badminton_turnamen">Tambah</button>
                                                  <br>
                                                  <br>
                                                   <table class="table table-striped table-bordered">
                                                    <thead>
                                                    ...
                                                    <?php 
                                                    $no=1;
                                                    foreach ($badminton_turnamen as $d1) { ?>
                                                      <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        ...
                                                        <td>
                                                          ...
                                                          <div role="group" class="btn-group-sm btn-group">
                                                           <button type="button" class="btn btn-outline-info btn-xs" data-toggle="modal" data-target="#edit_badminton_turnamen" onclick="edit_turnamen('<?php echo $d1['id_badminton_turnamen'] ?>')">
                                                           Edit</button>
                                                           <button type="button" class="btn btn-outline-info btn-xs" onclick="hapus_turnamen('<?php echo $d1['id_badminton_turnamen'] ?>','<?php echo $d1['paket'] ?>')">
                                                          Hapus
                                                        </button>
                                                      </div>
                                                  ...
                                                  <?php foreach ($galerry as $k => $v) { 
                                                    ?>
                                                      <div class="col-md-3 mb-3 justify-content-center">
                                                       ...
                                                       <a href="<?php echo base_url() ?>file/public/badminton/<?php echo $v['file'] ?>"  data-lightbox="image-1" data-title="My Foto" >
                                                         <img width="100%" class="rounded img-thumbnail" src="<?php echo base_url() ?>file/public/badminton/<?php echo $v['file'] ?>" alt="" >
                                                       </a>
                                                       <br>
