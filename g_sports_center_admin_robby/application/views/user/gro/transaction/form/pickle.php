  ...
  <script type="text/javascript">
    ...
    function konfirmasi(){
        ...
        if (simpan_kembalian<0) {
          $('#konfirmasi_pickle_caption_dibayar').html('DP');
          $('#konfirmasi_pickle_caption_kembalian').html('Sisa Pembayaran');
        }else{
          $('#konfirmasi_pickle_caption_dibayar').html('Dibayar');
          $('#konfirmasi_pickle_caption_kembalian').html('Kembalian');
    ...
    $('#konfirmasi_pickle').find('#konfirmasi_pickle_biaya').html(number_format(simpan_total));
    $('#konfirmasi_pickle').find('#konfirmasi_pickle_potongan').html(diskon);
    // $('#konfirmasi_pickle').find('#konfirmasi_pickle_student_card').html(formdata[25].value);
    $('#konfirmasi_pickle').find('#konfirmasi_pickle_tagihan').html(number_format(simpan_tagihan));
    $('#konfirmasi_pickle').find('#konfirmasi_pickle_dibayar').html(number_format(simpan_dibayar));
    $('#konfirmasi_pickle').find('#konfirmasi_pickle_kembalian').html(number_format(simpan_kembalian));





        $('#konfirmasi_pickle').find('#konfirmasi_pickle_tgl_main').html(tgl_main + '<br>Lapangan '+ lapangan);
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_jam_main').html(`<ol>`);
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_nama').html(nama);
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_alamat').html(alamat);
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_nohp').html(nohp);
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_keterangan').html(keterangan);
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_status').html(status);
      $('input[type=checkbox]').each(function () {
        ...
        $('#konfirmasi_pickle').find('#konfirmasi_pickle_jam_main').append(`</ol>`);
    ...
    function tampilkan_jadwal_main(){
     ...
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/pickle/jadwal_tersedia'),
              type    : 'POST',
              dataType : 'JSON',
              data    : { 
                tgl_main : tgl_main,
...
$('#input_dibayar').keyup(function(){
  ...
  function simpan_transaksi_pickle(){
    ...
    var formdata = $('#form_pickle').serialize();
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/pickle/simpan_transaksi_pickle'),
              type    : 'POST',
              // dataType : 'JSON',
...
<div class="alert alert-info">Transaksi pickle - Harian Disimpan <br>
...
<button id="btn_tab_new_transaction" class="btn btn-info" data-toggle="tab" href="#new_transaction" onclick="show_pilihan_fasilitas()">
  ...
  function print_transaksi(id_transaksi){
     $('#konfirmasi_pickle').modal('hide');
    $('#print_transaksi_gym').modal('show');
    $('#print_transaksi_gym').find('#struk_order_member_gym').html(`
      <iframe src="`+ baseUrl('/user/gro/transaction/pickle/print_transaksi_pickle_harian/') + id_transaksi +`/?status_print=settlement&action=Lunas" width="100%" height="400px"></iframe>
      `);
  }
