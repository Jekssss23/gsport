                                                  ...
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="form-group" id="form_tgl_main">
                                                          ...
                                                          <select class="form-control" name="turnamen" id="turnamen">
                                                            <?php foreach ($futsal as $k => $v) { ?>
                                                              <option value="<?php echo $v['harga'].'|'.$v['id_futsal_turnamen'].'|'.$v['paket'].'|'.$v['include_kebersihan'].'|'.$v['include_sound_system'] ?>"><?php echo $v['paket'] ?></option>
                                                            <?php } ?>
                                                           </select>
                                                        </div>
  ...
  <script type="text/javascript">
    ...
    function konfirmasi(){
        ...
        // }
          ...
          $('#konfirmasi_futsal_turnamen').modal('show');
          }
    ...
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_biaya_lapangan').html(number_format(simpan_biaya_main));
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_biaya_total').html(number_format(simpan_total));
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_potongan').html(diskon);
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_paket').html(paket);
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_tagihan').html(number_format(simpan_tagihan));
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_dibayar').html(number_format(simpan_dibayar));
    $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_kembalian').html(number_format(simpan_kembalian));


        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_biaya_tambahan').html('Biaya Kebersihan : '+ number_format(konfirm_biaya_kebersihan) + '<br>Biaya Sound System : '+ number_format(konfirm_biaya_sound_system));



        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_tgl_main').html(tgl_main + '<br>Lapangan '+ lapangan);
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_jam_main').html(`<ol>`);
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_nama').html(nama);
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_alamat').html(alamat);
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_nohp').html(nohp);
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_keterangan').html(keterangan);
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_status').html(status);
      $('.checkbok_jam').each(function () {
           if (this.checked) {
            var value = $(this).val();
           let pecah_val = value.split("|");

              $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_jam_main').append(`<li>`+pecah_val[0]+` - Rp. `+number_format(pecah_val[1])+`</li>`);
           }
});
        $('#konfirmasi_futsal_turnamen').find('#konfirmasi_futsal_turnamen_jam_main').append(`</ol>`);
    ...
    if ($('#tgl_main').val()=='') {
     ...
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/futsal_turnamen/jadwal_tersedia'),
              type    : 'POST',
              dataType : 'JSON',
              data    : { 
                tgl_main : tgl_main,
...
$('#input_dibayar').keyup(function(){
  ...
  function simpan_transaksi_futsal(){
    ...
    var formdata = $('#form_futsal').serialize();
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/futsal_turnamen/simpan_transaksi_futsal'),
              type    : 'POST',
              // dataType : 'JSON',
...
<div class="alert alert-info">Transaksi Futsal - Turnamen Disimpan <br>
...
<button id="btn_tab_new_transaction" class="btn btn-info" data-toggle="tab" href="#new_transaction" onclick="show_pilihan_fasilitas()">
  ...
  function print_transaksi(id_transaksi){
     $('#konfirmasi_futsal_turnamen').modal('hide');
    $('#print_transaksi_gym').modal('show');
    $('#print_transaksi_gym').find('#struk_order_member_gym').html(`
      <iframe src="`+ baseUrl('/user/gro/transaction/futsal_turnamen/print_transaksi_futsal_turnamen/') + id_transaksi +`/?status_print=settlement&action=Lunas" width="100%" height="400px"></iframe>
      `);
  }
