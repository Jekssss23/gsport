<form id="form_badminton">
  ...
  <input type="hidden" name="id_pengunjung" id="id_pengunjung">
    <div class="main-card mb-3 card">
                                        <div class="card-header">jadwal badminton</div>
                                        <div class="card-body">
                                          ...
                                          <input type="hidden" name="simpan_biaya_badminton" id="simpan_biaya_badminton" value="">
...
showAutoCurrency();
  ...
  <script type="text/javascript">
    jadwal_badminton_tersetting();
    function jadwal_badminton_tersetting(){
      var diskon = parseInt(<?php echo $diskon ?>);
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/badminton_bulanan/jadwal_badminton_tersetting'),
              type    : 'POST',
              dataType : 'JSON',
              data    : {}, 
              success : function(data)
              {
                ...
                $('#simpan_biaya_badminton').val(data.total_biaya);
    ...
    function konfirmasi(){
        ...
        // }
          ...
          $('#konfirmasi_badminton_bulanan').modal('show');
        }
    ...
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_tgl_1').html(format_tanggal(tgl_1_terpilih));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_tgl_2').html(format_tanggal(tgl_2_terpilih));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_tgl_3').html(format_tanggal(tgl_3_terpilih));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_tgl_4').html(format_tanggal(tgl_4_terpilih));
    ...
    html_jam_1 += "<ol>";
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_1').html(html_jam_1);
    ...
    html_jam_2 += "<ol>";
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_2').html(html_jam_2);
    ...
    html_jam_3 += "<ol>";
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_3').html(html_jam_3);
    ...
    html_jam_4 += "<ol>";
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_4').html(html_jam_4);
    ...
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_biaya_1').html(number_format(biaya_1_terpilih));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_biaya_2').html(number_format(biaya_2_terpilih));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_biaya_3').html(number_format(biaya_3_terpilih));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_biaya_4').html(number_format(biaya_4_terpilih));
    ...
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_status_1').html(status_1_terpilih);
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_status_2').html(status_2_terpilih);
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_status_3').html(status_3_terpilih);
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_status_4').html(status_4_terpilih);


        var simpan_total = $('#simpan_total').val();
        var simpan_biaya_badminton = $('#simpan_biaya_badminton').val();
        var diskon_bulanan = $('#diskon_bulanan').val();
        var simpan_diskon_bulanan = $('#simpan_diskon_bulanan').val();



    $('#konfirmasi_badminton_bulanan').find('#biaya_badminton').html(number_format(simpan_biaya_badminton));
    $('#konfirmasi_badminton_bulanan').find('#diskon_bulanan_biaya_badminton').html(diskon_bulanan);
    $('#konfirmasi_badminton_bulanan').find('#nilai_diskon_bulanan_biaya_badminton').html(number_format(simpan_diskon_bulanan));
    $('#konfirmasi_badminton_bulanan').find('#total_biaya_badminton').html(number_format(simpan_total));
    ...
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_biaya').html(number_format(simpan_total));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_potongan').html(diskon);
    // $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_student_card').html(formdata[25].value);
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_tagihan').html(number_format(simpan_tagihan));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_dibayar').html(number_format(simpan_dibayar));
    $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_kembalian').html(number_format(simpan_kembalian));





        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_tgl_main').html(tgl_main + '<br>Lapangan '+ lapangan);
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_main').html(`<ol>`);
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_nama').html(nama);
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_alamat').html(alamat);
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_nohp').html(nohp);
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_keterangan').html(keterangan);
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_status').html(status);
      $('#jadwal_badminton_bulanan').find('input[type=checkbox]').each(function () {
           if (this.checked) {
            var value = $(this).val();
           let pecah_val = value.split("|");

              $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_main').append(`<li>`+pecah_val[0]+` - Rp. `+number_format(pecah_val[1])+`</li>`);
           }
});
        $('#konfirmasi_badminton_bulanan').find('#konfirmasi_badminton_bulanan_jam_main').append(`</ol>`);


    }

    function pilih_jadwal(ke){
      $('#jadwal_badminton_bulanan').find('#tgl_main').val('').change();
      $('#jadwal_badminton_bulanan').find('#simpan_lama_main').val(0)
      $('#jadwal_badminton_bulanan').find('#total_biaya').val(0)
        $('#jadwal_badminton_bulanan').find('#lapangan').html('');
      var lapangan = '<?php echo $lapangan ?>';
      var parse = JSON.parse(lapangan);
      console.log(parse);
      $.each(parse, function (k,v){
        $('#jadwal_badminton_bulanan').find('#lapangan').append('<option value="'+v.lapangan+'">Lapangan '+ v.lapangan+'</option>');
        // console.log(v.lapangan);
      });
  ...
  function dt_member(){
    ...
    $('#data_member_futsal_badminton').find('#jenis_fasilitas').html('badminton');
    $('#list_member_futsal_badminton').DataTable(
    {
          ...
          responsive  : true,
          ajax    : {
                   url: '<?php echo base_url() ?>user/gro/transaction/badminton/dt_member',
                    type  : "POST",
                    data  : {
                    },
                  },
  ...
  function set_jadwal_badminton(){
        ...
        var input_jam_main = $('#jadwal_badminton_bulanan').find('#jam_main').val();
        var lapangan = $('#jadwal_badminton_bulanan').find('#lapangan').val();
        var jadwal_ke = $('#jadwal_badminton_bulanan').find('#jadwal_ke').val();
        var lama_main = $('#jadwal_badminton_bulanan').find('#simpan_lama_main').val();
        var biaya = $('#jadwal_badminton_bulanan').find('#total_biaya').val();
        var status = $('#jadwal_badminton_bulanan').find('#status').val();
      ...
      $('#jadwal_badminton_bulanan').find('input[type=checkbox]').each(function () {
           ...
           var jam_main = pecah_val[0]
            kumpul_jadwal.push(jam_main); 
              ...
              // $('#konfirmasi_badminton').find('#konfirmasi_badminton_jam_main').append(`<li>`+pecah_val[0]+` - Rp. `+number_format(pecah_val[1])+`</li>`);
           }
});
    ...
    var formdata = $('#jadwal_badminton_bulanan').find('#form_pilihan_jadwal_badminton').serialize();

     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/badminton_bulanan/set_jadwal_main'),
              type    : 'POST',
              dataType : 'JSON',
              data    : formdata, 
              success : function(data)
              ...
              if (data.response=='200') {
                toastr.success('Jadwal badminton Disimpan');
      ...
      $('#jadwal_badminton_bulanan').modal('hide');
    ...
    function hitung_jam(x){
        ...
        $('#potongan_harga').val('').change();
      jumlah_jam = $('#jadwal_badminton_bulanan').find('.checkbok_jam').filter(':checked').length;
      ...
      if (jumlah_jam==0) {
        ...
        $('#jadwal_badminton_bulanan').find('.lama_main').html(jumlah_jam + " Jam");
        $('#jadwal_badminton_bulanan').find('#simpan_lama_main').val(jumlah_jam);
        $('#jadwal_badminton_bulanan').find('#total_biaya').val(biaya_setelahnya);
  ...
  function simpanedit_identitas(){
    ...
    var formdata = $('#form_badminton').serialize();
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/badminton/simpanedit_identitas'),
              type    : 'POST',
              data    : formdata,
              dataType : 'JSON',
              success : function(data)
  ...
  function simpan_transaksi_badminton_bulanan(){

    var formdata = $('#form_badminton').serialize();
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/badminton_bulanan/simpan_transaksi_badminton_bulanan'),
              type    : 'POST',
              // dataType : 'JSON',
...
<div class="alert alert-info">Transaksi badminton - Member Bulanan Disimpan <br>
...
<button id="btn_tab_new_transaction" class="btn btn-info" data-toggle="tab" href="#new_transaction" onclick="show_pilihan_fasilitas()">
  ...
  function print_transaksi(id_transaksi){
     $('#konfirmasi_badminton_bulanan').modal('hide');
    $('#print_transaksi_gym').modal('show');
    $('#print_transaksi_gym').find('#struk_order_member_gym').html(`
      <iframe src="`+ baseUrl('/user/gro/transaction/badminton_bulanan/print_transaksi_badminton_bulanan/') + id_transaksi +`/?status_print=settlement&action=Lunas" width="100%" height="400px"></iframe>
      `);
  }
