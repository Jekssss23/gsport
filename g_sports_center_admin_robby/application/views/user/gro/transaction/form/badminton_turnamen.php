  ...
  <div class="col-md-4">
    ...
    <div class="main-card mb-3 card">
                                        ...
                                        <div class="card-body">
                                          ...
                                          <input type="hidden" name="simpan_biaya_kebersihan" id="simpan_biaya_kebersihan" value="0">
                                          <input type="hidden" name="simpan_biaya_sound_system" id="simpan_biaya_sound_system" value="0">
                                          <input type="hidden" name="simpan_biaya_main" id="simpan_biaya_main" value="0">
                                          ...
                                          <input type="hidden" name="opsi_tambah_metode_pembayaran" id="opsi_tambah_metode_pembayaran">
                                            ...
                                            <ul class="list-group list-group-flush">
                                              ...
                                              <li class="list-group-item">
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    ...
                                                    <div class="form-group" id="form_tgl_main">
                                                          <label>Paket Turnamen</label>
                                                          <select class="form-control" name="turnamen" id="turnamen">
                                                            <?php foreach ($badminton as $k => $v) { ?>
                                                              <option value="<?php echo $v['harga'].'|'.$v['id_badminton_turnamen'].'|'.$v['paket'].'|'.$v['include_kebersihan'].'|'.$v['include_sound_system'] ?>"><?php echo $v['paket'] ?></option>
                                                            <?php } ?>
                                                           </select>
                                                        </div>
                                                ...
                                                <div class="row">
                                                  <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                      <input type="checkbox" name="" id="include_kebersihan" disabled="disabled"> <b>Include Kebersihan</b>    
                                                    </div>
                                                  ...
                                                  <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                      <input type="checkbox" name="" id="include_sound_system" disabled="disabled"> <b>Include Sound System</b>    
                                                    </div>
                                                  ...
                                                  <div class="col-md-6">
                                                    ...
                                                    <div class="form-group" id="form_tgl_main">
                                                          ...
                                                          <select class="form-control" name="lapangan" id="lapangan">
                                                            <?php foreach ($lapangan as $k => $v) { ?>
                                                            <option value="<?php echo $v['lapangan'] ?>">Lapangan <?php echo $v['lapangan'] ?></option>
                                                            <?php } ?>
                                                           </select>
                                                        </div>
                                              ...
                                              <li class="list-group-item">
                                                <div class="row">
                                                  <div class="col-md-5 col-lg-5" style="border">
                                                          ...
                                                          <div class="widget-content p-0 w-100">
                                                              <div class="widget-content-outer">
                                                                  <div class="widget-content-left fsize-1">
                                                                      <div class="text-muted opacity-6">Biaya Tambahan</div>
                                                                  </div>
                                                                  <div class="widget-content-wrapper">
                                                                      <div class="widget-numbers mt-0 fsize-2"><small class="text-dark"><b class="biaya_tambahan">Pilih tanggal main dulu</b></small></div>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                      </div>
...
showAutoCurrency();
  ...
  <script type="text/javascript">
      var biaya_kebersihan = parseInt('<?php echo $biaya_tambahan['biaya_kebersihan'] ?>');
      var biaya_sound_system = parseInt('<?php echo $biaya_tambahan['biaya_sound_system'] ?>');

      cek_biaya_lainnya();
      function cek_biaya_lainnya(){
        var turnamen = $('#turnamen').val();
        let pecah_val = turnamen.split("|");
        var include_kebersihan = pecah_val[3];
        var include_sound_system = pecah_val[4];
      $('.biaya_tambahan').html('');
        var biaya_kebersihan_terpilih = 0;
        var biaya_sound_system_terpilih = 0;
      if (include_kebersihan==1) {
        $('#include_kebersihan').prop('checked', true);
        $('.biaya_tambahan').append('Biaya Kebersihan : Free');
        biaya_kebersihan_terpilih = 0;
      }else{
        $('#include_kebersihan').prop('checked', false);
        biaya_kebersihan_terpilih = biaya_kebersihan;
        $('.biaya_tambahan').append('Biaya Kebersihan : '+ number_format(biaya_kebersihan_terpilih));
      }
      if (include_sound_system==1) {
        biaya_sound_system_terpilih = 0;
        $('#include_sound_system').prop('checked', true);
        $('.biaya_tambahan').append('<br>Biaya Sound System : Free');
      }else{  
        biaya_sound_system_terpilih = biaya_sound_system;
        $('.biaya_tambahan').append('<br>Biaya Sound System : '+ number_format(biaya_sound_system_terpilih));
        $('#include_sound_system').prop('checked', false);
      }
      $('#simpan_biaya_kebersihan').val(biaya_kebersihan_terpilih);
      $('#simpan_biaya_sound_system').val(biaya_sound_system_terpilih);
    ...
    function konfirmasi(){
        ...
        // }
          ...
          $('#konfirmasi_badminton_turnamen').modal('show');
          }
     ...
     let pecah_val = turnamen.split("|");
     var biaya = pecah_val[0];
     var paket = pecah_val[2];
    ...
    var biaya_paket = parseInt(biaya) ;
    var konfirm_biaya_kebersihan =$('#simpan_biaya_kebersihan').val();;
    var konfirm_biaya_sound_system =$('#simpan_biaya_sound_system').val();;

    var simpan_total = $('#simpan_total').val();

    var simpan_tagihan = $('#simpan_tagihan').val();
    var simpan_biaya_main = $('#simpan_biaya_main').val();
    var simpan_dibayar = $('#simpan_dibayar').val();
    var simpan_kembalian = $('#simpan_kembalian').val();
    ...
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_biaya_lapangan').html(number_format(simpan_biaya_main));
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_biaya_total').html(number_format(simpan_total));
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_potongan').html(diskon);
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_paket').html(paket);
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_tagihan').html(number_format(simpan_tagihan));
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_dibayar').html(number_format(simpan_dibayar));
    $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_kembalian').html(number_format(simpan_kembalian));


        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_biaya_tambahan').html('Biaya Kebersihan : '+ number_format(konfirm_biaya_kebersihan) + '<br>Biaya Sound System : '+ number_format(konfirm_biaya_sound_system));



        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_tgl_main').html(tgl_main + '<br>Lapangan '+ lapangan);
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_jam_main').html(`<ol>`);
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_nama').html(nama);
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_alamat').html(alamat);
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_nohp').html(nohp);
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_keterangan').html(keterangan);
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_status').html(status);
      $('.checkbok_jam').each(function () {
           if (this.checked) {
            var value = $(this).val();
           let pecah_val = value.split("|");

              $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_jam_main').append(`<li>`+pecah_val[0]+` - Rp. `+number_format(pecah_val[1])+`</li>`);
           }
});
        $('#konfirmasi_badminton_turnamen').find('#konfirmasi_badminton_turnamen_jam_main').append(`</ol>`);


    }

    $('#turnamen').change(function(){
    ...
    $('#lapangan').change(function(){
      if ($('#tgl_main').val()=='') {
          $('#pilihan_jam').html('<div class="col-md-12 alert alert-info">Pilih tanggal dulu</div>');
      }else{
        tampilkan_jadwal_main();
      }
    });
    ...
    function tampilkan_jadwal_main(){
      ...
      var lapangan = $('#lapangan').val();
        ...
        $('#simpan_biaya_main').val(0)

        $('#potongan_harga').val('').change();

        $('#jam_main_dipilih').html("Pilih Jadwal Main");
      ...
      var biaya = pecah_val[0];
      $('.biaya_perjam').html("Biaya per jam : "+number_format(biaya));
      $('#jam_main_dipilih').html("Pilih Jadwal Main");


        $('.biaya_main').html(number_format(0));
    ...
    if ($('#tgl_main').val()=='') {
     ...
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/badminton_turnamen/jadwal_tersedia'),
              type    : 'POST',
              dataType : 'JSON',
              data    : { 
                tgl_main : tgl_main,
              ...
              success : function(data)
              {
                ...
                $.each(data, function (k,v){
                  ...
                  $.each(v, function(k_jam, v_jam){
                    ...
                    $('.show_jam_' +k ).append('<input type="checkbox" name="jam_main[]" class="checkbok_jam" value="'+v_jam.jam+'|'+biaya+'" style="margin-right:5px" onclick="hitung_jam(this)" biaya="'+biaya+'" jam_main="'+v_jam.jam+'"><span style="color:green;">'+v_jam.jam+'</span><br>');
                    }
    ...
    function hitung_jam(x){
      ...
      var biaya_kebersihan_terpilih = $('#simpan_biaya_kebersihan').val();
      var biaya_sound_system_terpilih = $('#simpan_biaya_sound_system').val();
      var total_biaya_tambahan = parseInt(biaya_kebersihan_terpilih) + parseInt(biaya_sound_system_terpilih) ; 
      ...
      var biaya_sebelumnya = $('#simpan_biaya_main').val();
      ...
      if (jumlah_jam==0) {
        ...
        $('.biaya_main').html(number_format(biaya_setelahnya));
        $('#jam_main_dipilih').html("Total Biaya Lapangan ["+ jumlah_jam +" Jam]");
        var total_biaya_semua = biaya_setelahnya + total_biaya_tambahan;
        $('#total_biaya').val(total_biaya_semua);
        $('#simpan_total').val(total_biaya_semua);

        $('#simpan_biaya_main').val(biaya_setelahnya);
        $('#simpan_tagihan').val(total_biaya_semua);
        $('#simpan_dibayar').val(total_biaya_semua);
        $('#simpan_kembalian').val(0);
        $('.lama_main').html(jumlah_jam + " Jam");
        $('#simpan_lama_main').val(jumlah_jam);

        $('#show_dibayar').html(number_format(total_biaya_semua));
        $('.biaya_total').html(number_format(total_biaya_semua));
        $('.tagihan').html(number_format(total_biaya_semua));
...
$('#input_dibayar').keyup(function(){
  ...
  function simpan_transaksi_badminton(){

    var formdata = $('#form_badminton').serialize();
     $.ajax(
            {
              url     : baseUrl('/user/gro/transaction/badminton_turnamen/simpan_transaksi_badminton'),
              type    : 'POST',
              // dataType : 'JSON',
...
<div class="alert alert-info">Transaksi badminton - Turnamen Disimpan <br>
...
<button id="btn_tab_new_transaction" class="btn btn-info" data-toggle="tab" href="#new_transaction" onclick="show_pilihan_fasilitas()">
  ...
  function print_transaksi(id_transaksi){
     $('#konfirmasi_badminton_turnamen').modal('hide');
    $('#print_transaksi_gym').modal('show');
    $('#print_transaksi_gym').find('#struk_order_member_gym').html(`
      <iframe src="`+ baseUrl('/user/gro/transaction/badminton_turnamen/print_transaksi_badminton_turnamen/') + id_transaksi +`/?status_print=settlement&action=Lunas" width="100%" height="400px"></iframe>
      `);
  }
