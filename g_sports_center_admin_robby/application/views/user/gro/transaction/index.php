  ...
  background-repeat: no-repeat;
    ...
    <audio id="song_tidak_ditemukan" >
      <source src="<?php echo base_url('file/ringtone/gojek.mp3') ?>" type="audio/mp3">
    </audio>  
    <audio id="song_ditemukan" >
      <source src="<?php echo base_url('file/ringtone/dana.mp3') ?>" type="audio/mp3">
    </audio>  


<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
                        <li class="nav-item">
                            <a role="tab" class="nav-link active" id="btn_tab_cek_data" data-toggle="tab" href="#cek_data" onclick="dt_member_reg_online()">
                                <span>Cek Data Member</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a role="tab" class="nav-link" id="btn_tab_new_transaction"  data-toggle="tab" href="#new_transaction_fasilitas" onclick="show_pilihan_fasilitas()">
                                <span>Transaksi Fasilitas</span>
                            </a>
                        </li> 
                    ...
                    <div class="tab-pane tabs-animation active fade show " id="cek_data" role="tabpanel">
                      <?php $this->load->view('user/gro/transaction/caridata') ?>
                    </div>
                         <div class="tab-pane tabs-animation fade" id="new_transaction_fasilitas" role="tabpanel">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <?php $this->load->view('user/gro/transaction/new_gym') ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
