...
<table class="font_laporan table" width="100%"> 
    ...
    <tr>
      ...
      <td align="right" valign="bottom">Diskon <?php echo $diskon.'%' ?></td>
    </tr>
    ...
    foreach ($produk as $k => $v) { 
      ...
      $nilai_diskon = $v['biaya'] * ($diskon / 100);
      $nilai_setelah_diskon = $v['biaya'] - $nilai_diskon ;
    $total_badminton +=$v['biaya'];
      ?>
    <tr>
      <td><?php echo $v['tgl_main'].' jam '.$v['jam_main'] ?> <br>  
      <?php echo number_format($v['biaya']) ?>
    </td>
      <td align="right" valign="bottom"><?php echo number_format($nilai_setelah_diskon  ) ?></td>
    </tr>
    <?php } ?>
  <?php 
  $total_semua = $transaksi['total']; 
  $nilai_diskon = ($diskon / 100) * $total_badminton;
  ?>
   </table>
   <hr>
   ...
   <table class="font_laporan table" width="100%">
    <tr>
      <td valign="top">Total Biaya Main</td>
      <td align="right" valign="top"><?php echo number_format($total_badminton) ?></td>
    </tr>
    <tr>
      <td valign="top">Diskon Member Bulanan (<?php echo $diskon ?>%)</td>
      <td align="right" valign="top"><?php echo number_format($nilai_diskon) ?></td>
    </tr>
    <tr>
      <td colspan="3"><hr></td>
    </tr>
