...
<table class="header" width="100%">
  <tr>
    <td valign="top">Nama Pengunjung</td>
    <td valign="top">:</td>
...
<?php   
$pecah_id_fasilitas = explode('|', $transaksi['id_fasilitas']);
$jumlah_orang = $pecah_id_fasilitas[2];
$harga_satuan = $pecah_id_fasilitas[1];
$kategori = $pecah_id_fasilitas[0];

 ?>
    <tr>
      <td><?php echo $transaksi['fasilitas'].'<br>'.$kategori.'<br>'.$transaksi['jenis_member'] ?></td>
      <td align="right" valign="bottom"></td>
    </tr>
    <tr>
      <td><?php echo $jumlah_orang ?> Orang * <?php echo number_format($harga_satuan) ?> </td>
      <td align="right" valign="bottom"><?php echo number_format($transaksi['total']) ?></td>
    </tr>
  <?php 
 ...
 <?php if ($transaksi['kategori_potongan']!='') {  ?>
  ...
  <tr>
    ...
    </tr>   <?php if ($transaksi['pembayaran']=='1 Metode Pembayaran') { ?>
    <tr>
