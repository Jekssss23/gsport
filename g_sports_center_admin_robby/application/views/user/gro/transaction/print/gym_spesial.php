...
<table class="header" width="100%">
  ...
  <tr>
    ...
    <td valign="top">:</td>
    <td valign="top"> <?php echo $transaksi['no_transaksi'].'-'.$transaksi['id_transaksi'] ?> </td>
  </tr>
  <tr>
...
<table class="header" width="100%">
  <tr>
    ...
    <td valign="top">:</td>
    <td valign="top"><?php echo $transaksi['kode_unik_member']; ?> </td>
  </tr>
  <tr>
...
<table class="font_laporan table" width="100%"> 
    ...
    <tr>
      <td><?php echo $transaksi['fasilitas'].'<br>'.$transaksi['jenis_member'] ?></td>
 ...
 <?php if ($transaksi['kategori_potongan']!='') {  ?>
  ...
  <hr>  
<?php  if ($transaksi['jumlah_poin']>0) { ?>
  <table class="font_laporan table" width="100%"> 
    <tr>
      <td>Anda Mendapatkan Poin </td>
      <td align="right"><?php echo $transaksi['jumlah_poin'] ?> Poin</td>
    </tr>
  </table>
  <br>  <br>  
<?php } ?>
