...
<table class="header" width="100%">
  <tr>
    ...
    <td valign="top">:</td>
    <td valign="top"><?php echo $transaksi['kategori_transaksi'].' - Lapangan '.$transaksi['lapangan'].'<br>Main Tanggal '.show_tanggal($transaksi['tgl_main']).''; ?> </td>
  </tr>
  <tr>
...
<table class="font_laporan table" width="100%"> 
    ...
    <tr>
      <td><?php echo $transaksi['fasilitas'].' [Paket '.$transaksi['paket'].']' ?></td>
      <td align="right" valign="bottom"></td>
    </tr>
    <tr>
      <td><?php echo $transaksi['jumlah_jam_main'] .' jam  * '. number_format($jam_main[0]['biaya']) ?></td>
      <td align="right" valign="bottom">
        <?php $biaya_lapangan = $jam_main[0]['biaya'] * $transaksi['jumlah_jam_main'];
        echo number_format($biaya_lapangan); ?>
      </td>
    </tr>
