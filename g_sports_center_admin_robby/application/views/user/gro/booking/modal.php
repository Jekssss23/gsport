              ...
              <div class="modal-body">
                ...
                <input type="hidden" name="" id="jenis_futsal">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6 col-md-6 col-xl-6 form_pembayaran_visit">
                      ...
                      <div class="col-sm-6 col-md-3 col-xl-6 form_pembayaran_visit">
              ...
              <div class="modal-body">
                ...
                <input type="hidden" name="" id="jenis_badminton">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 ">
                        <div class="row" id="form_tambah_metode_pembayaran_badminton" >
                          <div class="col-sm-12 col-md-12 col-xl-12">
                          <div class="form-group">
                           <button class="btn btn-outline-info btn-block btn-sm" type="button" onclick="tambah_metode_pembayaran()" id="tombol_tambah_metode_pembayaran" style="display:none">Tambah Metode Pembayaran</button>
                         </div>
...
<!-- Pickle -->
<form action="#" id="form_konfirmasi_booking_pickle" method='post'> 
<div class="modal fade" id="cek_jadwal_pickle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Order <span id="fasilitas"></span></h5>
               ...
               <div class="row">
                  ...
                  <hr>  
                    ...
                    <table class="table">
                      ...
                      <thead>
                        <tr>
                        <td colspan="7"><b>Jadwal pickle</b> <span id="nama_paket"></span></td>
...
<div class="modal fade" id="konfirmasi_pembayaran_booking_pickle" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="title">Pembayaran <br> <span class="nama"></span></h5>
              ...
              <div class="modal-body">
                ...
                <input type="hidden" name="" id="jenis_pickle">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-12 ">
                        <div class="row" id="form_tambah_metode_pembayaran_pickle" >
                          <div class="col-sm-12 col-md-12 col-xl-12">
                          <div class="form-group">
                           <button class="btn btn-outline-info btn-block btn-sm" type="button" onclick="tambah_metode_pembayaran()" id="tombol_tambah_metode_pembayaran" style="display:none">Tambah Metode Pembayaran</button>
                         </div>
                      ...
                      <div class="col-sm-6 col-md-3 col-xl-6 form_pembayaran_visit">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <button class="btn btn-block btn-success mt-3" type="button" onclick="simpan_visit_pickle_harian()" id="tombol_visit_harian">Simpan Visit</button>
                            <button class="btn btn-block btn-info mt-3" type="button" onclick="simpan_visit_pickle_turnamen()" id="tombol_visit_turnamen">Simpan Visit</button>
                        </div>
...
<div class="modal fade" id="jadwal_pickle_bulanan" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-header">
              ...
              <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <button class="btn btn-block btn-info" onclick="set_jadwal_pickle()" type="button" id="tombol_update_jadwal">Simpan</button>
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  data_order_pickle('harian');
  function data_order_pickle(jenis){
    dt_order_pickle(jenis);
  }
  function dt_order_pickle(jenis){

    // $('#data_student_card').modal('show');
    $('#list_order_pickle_' + jenis).DataTable(
    {
          processing  : true,
          serverSide  : true,
          bDestroy  : true,
          // responsive  : true,
          ajax    : {
                   url: '<?php echo base_url() ?>user/gro/booking/dt_order_pickle',
                    type  : "POST",
                    data  : {
                      tgl : '<?php echo $this->input->get('tgl') ?>',
                      jenis : jenis
  ...
  rekap_futsal('bulanan', '<?php echo $bulan ?>', '<?php echo $tahun ?>');
  function rekap_futsal(jenis, bulan, tahun){
    dt_rekap_futsal(jenis, bulan, tahun);
  }
  function rekap_futsal_semua(jenis, bulan, tahun){
    $('#caption_rekap_futsal_bulanan').html('Rekap Member Futsal Bulanan <br>Semua Data');
    dt_rekap_futsal(jenis, bulan, tahun);
  }
  ...
  function dt_rekap_futsal(jenis, bulan, tahun){
    ...
    if (jenis=='bulanan' ||  jenis=='semua') {
      var tabel_bulanan = 'bulanan';
    }
    // $('#data_student_card').modal('show');
    $('#list_rekap_futsal_' + tabel_bulanan).DataTable(
    {
          processing  : true,
          serverSide  : true,
          bDestroy  : true,
  ...
  function rekap_badminton_semua(jenis, bulan, tahun){
    $('#caption_rekap_badminton_bulanan').html('Rekap Member Badminton Bulanan <br>Semua Data');
    dt_rekap_badminton(jenis, bulan, tahun);
  }
  function dt_rekap_badminton(jenis, bulan, tahun){
    ...
    // $('#data_student_card').modal('show');
    $('#list_rekap_badminton_' + tabel_bulanan).DataTable(
    {
          processing  : true,
          serverSide  : true,
          bDestroy  : true,
  ...
  rekap_pickle('bulanan', '<?php echo date('m') ?>', '<?php echo date('Y') ?>');
  function rekap_pickle(jenis, bulan, tahun){
    dt_rekap_pickle(jenis, bulan, tahun);
  }
  
  function rekap_pickle_semua(jenis, bulan, tahun){
    $('#caption_rekap_pickle_bulanan').html('Rekap Member pickle Bulanan <br>Semua Data');
    dt_rekap_pickle(jenis, bulan, tahun);
  }
  function dt_rekap_pickle(jenis, bulan, tahun){
    if (jenis=='bulanan' ||  jenis=='semua') {
      var tabel_bulanan = 'bulanan';
    }
    // $('#data_student_card').modal('show');
    $('#list_rekap_pickle_' + tabel_bulanan).DataTable(
    {
          processing  : true,
          serverSide  : true,
          bDestroy  : true,
          // responsive  : true,
          ajax    : {
                   url: '<?php echo base_url() ?>user/gro/booking/dt_rekap_pickle',
                    type  : "POST",
                    data  : {
                      tgl : '<?php echo $this->input->get('tgl') ?>',
                      bulan : bulan,
