...
if ($this->session->userdata('login')!=true) {
    $this->session->set_flashdata('pesan','<div class="alert alert-danger"> Harap melakukan login dulu
                    </div>');
    redirect('auth/login');
}
...
<head>
    ...
    <title>G-Sports Center <?php echo date('Y-m-d H:i:s') ?></title>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    ...
    <div class="app-header header-shadow">
        <div class="app-header__logo">
            <img src="<?php echo base_url() ?>assets/gambar/logo.png" style="width:100px; margin-left:40px">
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                        <img width="42" class="" src="<?php echo  base_url('file/user/'.$foto) ?>" alt="">
                                        <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                    </a>



                                    <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-292px, -3px, 0px);">
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                  <img width="42" class=""
                                                                     src="<?php echo  base_url('file/user/'.$foto) ?>"
                                                                     alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading"><?php echo $nama_user ?>
                                                                </div>
                                                                <div class="widget-subheading opacity-8"><?php echo $jabatan_user ?>
                                                                </div>
                                                            </div>
                                                            <div class="widget-content-right mr-2">
                                                                <a href="<?php echo base_url('auth/login/logout') ?>" class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="scrollbar-container ps ps--active-y">
                                                <ul class="nav flex-column">
                                                   ...
                                                   <!--  <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="<?php echo base_url('user/account/edit_password') ?>" class="nav-link">Ganti Password
                                                        </a>
                                                    </li>
                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li class="app-sidebar__heading">Menu</li>
                             <li>
                                    <a href="<?php echo base_url() ?>user/user/dashboard"  style="color:blue">
                                            <i class="metismenu-icon pe-7s-gym">
                                            </i>Dashboard
                                        </a>
                                    </li>
                            <?php if (in_array(2, $id_hak_akses)) { ?>
                             <li>
                                    <a href="<?php echo base_url() ?>user/admin/export_db/backup_db"  style="color:blue">
                                            <i class="metismenu-icon pe-7s-gym">
                                            </i>Backup Database
                                        </a>
                                    </li>
                            <?php } ?>
                        <?php 
                        $list_id_ha =  join(',', $id_hak_akses);
                        $q_menu = $this->db->query("SELECT * from menu_groups mg left join menu m on mg.id_menu=m.id_menu where mg.id_hak_akses in ($list_id_ha) group by mg.id_menu")->result_array();
                        foreach ($q_menu as $k => $v) { 
                            $link = $v['link'];
                                    // if(preg_match("variabel_tanggal", $link)) {

                                        $show_link =  str_replace('variabel_tanggal', date('Y-m-d'), $link);
                                        $show_link =  str_replace('variabel_bulan', date('n'), $show_link);
                                        $show_link =  str_replace('variabel_tahun', date('Y'), $show_link);
                                    // }
                                    // else {
                                    //     $show_link =  $link;
                                    // }
                            ...
                            ?>
                              <li>
                                    <a href="<?php echo base_url($show_link) ?>"  style="color:blue">
                                            <i class="<?php echo $v['icon'] ?>">
                                            </i><?php echo $v['menu_name'] ?>
                                        </a>
                                    </li>
                        <?php  } ?>
                            ...
                            <div class="page-title-heading">
                                ...
                                <div>
                                      <?php if (isset($judul)) {
                                            ...
                                            echo ucwords($this->router->fetch_class());
                                        } ?>
                    ...
                    <div class="app-footer">
                        <div class="app-footer__inner">
                            ...
                            <div class="app-footer-right">
                                <ul class="header-megamenu nav">
                                    <li class="nav-item">
                                            Copyright  2025  <a href="https://www.instagram.com/gsportscenter/" target="_blank"> | G Sports Center </a> | Develop By <a href="https://www.instagram.com/hamidseptian/" target="_blank">Hamid Septian</a> & <a href="https://www.instagram.com/robbieardd/" target="_blank">Robbie Ardana</a>
...
let show = myArray[2]+ '-' + myArray[1] + '-'+ myArray[0];
return show;
}
