                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-secondary">
                                    <div class="menu-header-image opacity-5" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/abstract2.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-rounded dropdown-menu-lg rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-success">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/abstract3.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner bg-plum-plate">
                                    <div class="menu-header-image" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/abstract4.jpg');"></div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/city3.jpg');"></div>
                                                                        ...
                                                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/1.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/2.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/3.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/4.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/5.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/9.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/7.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                                                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                                                <div class="avatar-icon"><img
                                                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/8.jpg"
                                                                                        alt=""></div>
                                                                            </div>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
                                    <div class="menu-header-image opacity-05" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/city2.jpg');"></div>
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/1.jpg" alt="">
                                        <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                    </a>
                                    <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu-lg dropdown-menu dropdown-menu-right">
                                        <div class="dropdown-menu-header">
                                            <div class="dropdown-menu-header-inner bg-info">
                                                <div class="menu-header-image opacity-2" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/city3.jpg');"></div>
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                            ...
                            <!--<li class="theme-settings-swatches d-none list-group-item">
                                ...
                                <div class="swatch-holder swatch-holder-img active">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/city1.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/city2.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/city3.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/city4.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/city5.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/abstract1.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/abstract2.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/abstract3.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/abstract4.jpg">
                                    </a>
                                </div>
                                <div class="swatch-holder swatch-holder-img">
                                    <a class="img-holder switch-trigger">
                                        <img alt=" " src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/sidebar/abstract5.jpg">
                                    </a>
                                </div>
                            </li>-->
                        </ul>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            <li class="app-sidebar__heading">Nama User</li>
                          
                          
                            <li class="app-sidebar__heading">Hak Akses</li>
                            ...
                            <li class="app-sidebar__heading">Admin</li>
                                ...
                                <ul>
                                    <li>
                                        <a href="<?= base_url('class_management') ?>">
                                            <i class="metismenu-icon fa fa-graduation-cap"></i>
                                            Class Management
                                        </a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Jenis Member</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Metode Pembayaran</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Master FnB</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Master Sourvenir</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Diskon</a>
                                    </li>
                                  
                                </ul>
                            </li>
                            <li class="app-sidebar__heading">Operator</li>
                             <li class="mm-active">
                                <a href="#">
                                ...
                                <ul>
                                    <li>
                                        <a href="analytics.html">List Member</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Card</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Absensi</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Laporan</a>
                                    </li>
                                </ul>
                            </li>
                             <li class="mm-active">
                                ...
                                <ul>
                                    <li>
                                        <a href="analytics.html">Pengelolaan Stok</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Order</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Laporan</a>
                                    </li>
                             ...
                             <li class="mm-active">
                                ...
                                <ul>
                                    <li>
                                        <a href="analytics.html">Input Pengeluaran</a>
                                    </li>
                                    <li>
                                        <a href="analytics.html">Laporan</a>
                                    </li>
                                            ...
                                            <div class="d-none popover-custom-content">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-tempting-azure">
                                                        <div class="menu-header-image opacity-1" style="background-image: url('<?php echo base_url('assets/user_template/dist/') ?>assets/images/dropdown-header/city5.jpg');"></div>
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left"><img width="42" class="rounded" src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/1.jpg" alt=""/></div>
                                    </div>
                                    <div class="widget-content-left">
                                ...
                                <div class="vertical-timeline-element-content bounce-in">
                                    <h4 class="timeline-title">Something not important
                                        <div class="avatar-wrapper mt-2 avatar-wrapper-overlap">
                                            ...
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
                                                        src="<?php echo base_url('assets/user_template/dist/') ?>assets/images/avatars/6.jpg"
                                                        alt=""></div>
                                            </div>
                                            <div class="avatar-icon-wrapper avatar-icon-sm">
                                                <div class="avatar-icon"><img
...
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/app.js"></script>
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/demo.js"></script>

<!--CHARTS-->

<!--Apex Charts-->
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/vendors/charts/apex-charts.js"></script>

<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/charts/apex-charts.js"></script>
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/charts/apex-series.js"></script>

<!--Sparklines-->
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/vendors/charts/charts-sparklines.js"></script>
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/charts/charts-sparklines.js"></script>
...
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/charts/chartjs.js"></script>
...
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/toastr.js"></script>

<!--SweetAlert2-->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@8"></script>
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/sweet-alerts.js"></script>

<!--Tree View -->
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/vendors/treeview.js"></script>
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/treeview.js"></script>
...
<!--Bootstrap Tables-->
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/vendors/tables.js"></script>

<!--Tables Init-->
<script src="<?php echo base_url('assets/user_template/dist/') ?>assets/js/scripts-init/tables.js"></script>
