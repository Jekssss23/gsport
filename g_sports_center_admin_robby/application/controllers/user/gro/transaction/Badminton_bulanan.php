...
class Badminton_bulanan extends CI_Controller {
    ...
    public function jadwal_tersedia()
    {
        ...
        $q_master = $this->db->query("SELECT jam_mulai, jam_berakhir from master_badminton")->result_array();
    ...
    public function jadwal_badminton_tersetting()
    {
        $tgl = $this->input->post('tgl_main');
        $lapangan = $this->input->post('lapangan');
 ...
 public function set_jadwal_main(){
        ...
        foreach ($jam_main as $k => $v) {   
            ...
            $data = [
                ...
                'biaya' => $biaya,
                'jadwal_ke' => $jadwal_ke,
                'fasilitas'=>'Badminton - Member Bulanan',
                'status' => 'Set',
            ];
 ...
 public function simpan_transaksi_badminton_bulanan(){
        ...
        $diskon_badminton_bulanan   = $this->input->post('diskon_bulanan');
        ...
        $data_transaksi = [
            ...
            'jam_transaksi' => jams(),
            'order_ke' => $next_order,
            'order_ke_fasilitas' => next_order_fasilitas('Badminton - Member Bulanan'),
            'total' => $simpan_total,
        ...
        $id_identitas_order_badminton = $this->db->insert_id();
              $q = $this->db->update('jadwal_badminton',['status'=>$status,'id_transaksi'=>$id_transaksi,'id_identitas_order_badminton'=>$id_identitas_order_badminton], ['status'=>'Set']);
        ...
        foreach ($q_data as $k => $v) {   
            ...
            $biaya_setelah_diskon = $biaya - $diskon_bulanan;
             $pendapatan = [
                ...
                'keterangan'=> 'Badminton - Member Bulanan '.$nama.'<br>Jadwal ke : '.$jadwal_ke.' <br>tanggal '.$tgl.'<br>jam '.$jam,
        ...
        if ($this->input->post('metode_pembayaran_2')!=null) {
            ...
            $data_pembayaran = [
                [
                    ...
                    'item_transaksi' => 'Badminton - Member Bulanan', 
                    'keterangan'=>'Pembayaran Badminton - Member Bulanan a.n. '.$nama,
 ...
 public function print_transaksi_badminton_bulanan($id_transaksi)
    {
        ...
        ")->row_array();
         ...
         from transaksi t 
         left join identitas_order_badminton idf on t.id_transaksi = idf.id_transaksi
...
jam_main, tgl_main 
        ...
        $q_diskon = $this->db->query("SELECT diskon from diskon_member_badminton")->row_array();
        ...
        $data['t']='';
        $html = $this->load->view('user/gro/transaction/print/badminton_bulanan', $data, true);
