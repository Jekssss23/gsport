...
class pickle_turnamen extends CI_Controller {
 ...
 public function simpan_transaksi_pickle(){
        ...
        foreach ($jam_main as $k => $v) {   
            ...
            //     'keterangan'=> 'Pickle - Turnamen '.$nama.' | jam '.$jam,
        ...
        $biaya_sound_system = $this->input->post('simpan_biaya_sound_system');
             ...
             $pendapatan_kebersihan = [
                ...
                'keterangan'=> 'Biaya Kebersihan Pickle - Turnamen '.$nama,
                'tgl_transaksi'=>timestamp(),
                'id_user '=>id_user(),
             ...
             $pendapatan_sound_system = [
                ...
                'keterangan'=> 'Biaya Sound System Pickle - Turnamen '.$nama,
                'tgl_transaksi'=>timestamp(),
                'id_user '=>id_user(),
                'status'=>'Pending',
                'id_metode_pembayaran' =>'',
        ...
        if ($this->input->post('metode_pembayaran_2')!=null) {
            ...
            $data_pembayaran = [
                [
                    ...
                    'keterangan'=>'Pembayaran Pickle - Turnamen selama '.$jumlah_jam_main.' Jam pada tanggal '.$tgl_main,
            ...
            $data_pembayaran = [
                    ...
                    'item_transaksi' => 'Pickle - Turnamen', 
                    'keterangan'=>'Pembayaran Pickle - Turnamen selama '.$jumlah_jam_main.' Jam',
                    'tgl_transaksi' => timestamp(), 
                    'id_user' => id_user(), 
                    'status' => 'Preview',  
            ];
 ...
 public function print_transaksi_pickle_turnamen($id_transaksi)
    {
        ...
        ")->row_array();
         ...
         from transaksi t 
         left join identitas_order_pickle idf on t.id_transaksi = idf.id_transaksi_sementara
        ...
        $data['t']='';
        $html = $this->load->view('user/gro/transaction/print/pickle_turnamen', $data, true);
