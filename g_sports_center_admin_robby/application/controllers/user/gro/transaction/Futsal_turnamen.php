...
class Futsal_turnamen extends CI_Controller {
 ...
 public function simpan_transaksi_futsal(){
        ...
        foreach ($jam_main as $k => $v) {   
            ...
            //     'keterangan'=> 'Futsal - Turnamen '.$nama.' | jam '.$jam,
        ...
        $biaya_sound_system = $this->input->post('simpan_biaya_sound_system');
             ...
             $pendapatan_kebersihan = [
                ...
                'keterangan'=> 'Biaya Kebersihan Futsal - Turnamen '.$nama,
                'tgl_transaksi'=>timestamp(),
                'id_user '=>id_user(),
             ...
             $pendapatan_sound_system = [
                ...
                'keterangan'=> 'Biaya Sound System Futsal - Turnamen '.$nama,
                'tgl_transaksi'=>timestamp(),
                'id_user '=>id_user(),
                'status'=>'Pending',
                'id_metode_pembayaran' =>'',
        ...
        if ($this->input->post('metode_pembayaran_2')!=null) {
            ...
            $data_pembayaran = [
                [
                    ...
                    'keterangan'=>'Pembayaran Futsal - Turnamen selama '.$jumlah_jam_main.' Jam pada tanggal '.$tgl_main,
            ...
            $data_pembayaran = [
                    ...
                    'item_transaksi' => 'Futsal - Turnamen', 
                    'keterangan'=>'Pembayaran Futsal - Turnamen selama '.$jumlah_jam_main.' Jam',
                    'tgl_transaksi' => timestamp(), 
                    'id_user' => id_user(), 
                    'status' => 'Preview',  
            ];
 ...
 public function print_transaksi_futsal_turnamen($id_transaksi)
    {
        ...
        ")->row_array();
          ...
          t.no_transaksi, t.dibayar, t.kembalian, t.tgl_transaksi, t.jam_transaksi, t.order_ke, t.total, t.kategori_potongan, t.kategori_transaksi,
            ...
            idf.nama, idf.lapangan, idf.no_hp, idf.tgl_main, idf.status, (SELECT count(jam_main) from jadwal_futsal where id_transaksi_sementara=t.id_transaksi) as jumlah_jam_main
         from transaksi t 
         left join identitas_order_futsal idf on t.id_transaksi = idf.id_transaksi_sementara
        ...
        $jam_main = $this->db->query("SELECT id_detail_booking_futsal , biaya
        ...
        $data['t']='';
        $html = $this->load->view('user/gro/transaction/print/futsal_turnamen', $data, true);
