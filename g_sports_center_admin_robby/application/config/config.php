...
|
*/
$config['base_url'] = 'https://management.g-sportscenter.com/';
/*
|--------------------------------------------------------------------------
| Index File
|--------------------------------------------------------------------------
...
/*
|--------------------------------------------------------------------------
| Class QR attendance (HMAC secret for GSCATTv1 payloads — change in production)
|--------------------------------------------------------------------------
*/
$config['class_qr_secret'] = 'gsc-class-qr-change-this-to-a-long-random-string';
